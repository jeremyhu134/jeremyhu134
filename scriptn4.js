...
var phone3 = new Audio("https://vignette.wikia.nocookie.net/freddy-fazbears-pizza/images/9/9d/Voiceover4.ogg/revision/latest?cb=20140825000815");
...
function movement(){
        ...
        if(bmovetime <= 0){
           if(bonnie === 5){
               ...
               stomp2.play();
               bonnie = 5;
               bmovetime = Math.floor((Math.random() * 1500) + 500);
           }
        }
        if(cmovetime <= 0){
           if(chica === 5){
               chica = 6;
               cmovetime = Math.floor((Math.random() * 500) + 1000);
           }
           else if(chica === 6){
               chica = 7;
               cmovetime = Math.floor((Math.random() * 500) + 1000);
               ...
               rightlight = 0;
               chica = 5;
               cmovetime = Math.floor((Math.random() * 2000) + 500);
           }
        }
        if(fmovetime <= 0 ){
           if(freddy === 5){
        ...
        if(fxmovetime <= 0){
           if(foxy === 5 ){
               foxy = 4;
               fxmovetime = Math.floor((Math.random() * 1000) + 1500);
           }
